...
describe("Reading full amounts", function () {
  ...
  it("should read SDG 1.20", function () {
    assert.equal(
      "واحد جنيه مصري وعشرون قرش فقط لا غير",
  ...
  it("should read SDG 10,001", function () {
    assert.equal(
      "عشرة ألف وواحد جنيه مصري فقط لا غير",
  ...
  it("should read SDG 100,100", function () {
    assert.equal(
      "مائة ألف ومائة جنيه مصري فقط لا غير",
      new Tafgeet("100100").parse()
    );
  });
  it("should read SDG 55,000,051,000", function () {
    assert.equal(
      "خمسة وخمسون مليار وواحد وخمسون ألف جنيه مصري فقط لا غير",
